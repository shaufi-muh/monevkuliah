                ...
                <div class="flex flex-col space-y-4 p-4 h-full">
                    ...
                    <div class="border-gray-200 dark:border-gray-700"></div>
                        <div class="space-y-2">
                            ...
                            <x-nav-link :href="route('jurusan.broadcast.index')" :active="request()->routeIs('jurusan.broadcast*')">
                                <x-slot name="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                            ...
                            <!-- Menu 'User Prodi' dihapus — sekarang dikelola per-item di daftar prodi -->
                        </div>
                    </div>
                    @endif
