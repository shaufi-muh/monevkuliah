                ...
                <div class="flex flex-col space-y-4 p-4 h-full">
                    ...
                    <div class="border-gray-200 dark:border-gray-700"></div>
                        <div class="space-y-2">
                            ...
                            <x-nav-link :href="route('jurusan.semester-akademik.index')" :active="request()->routeIs('jurusan.semester-akademik*')">
                                <x-slot name="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                                        <path fill-rule="evenodd" d="M6.32 2.577a49.255 49.255 0 0 0-4.474 1.5A2.25 2.25 0 0 0 .75 6v12a2.25 2.25 0 0 0 1.096 1.937c1.457.694 3.21 1.264 5.154 1.702a60.46 60.46 0 0 0 5.5-1.65c1.933-.44 3.68-1.01 5.135-1.705A2.25 2.25 0 0 0 21.75 18V6a2.25 2.25 0 0 0-1.096-1.937c-1.457-.694-3.21-1.264-5.154-1.702a60.46 60.46 0 0 0-5.5 1.65c-1.933.44-3.68 1.01-5.135 1.705a2.25 2.25 0 0 0-.544-.176zm1.57-.802c1.88-.428 3.773-.725 5.61-.888a58.978 58.978 0 0 1 5.432-.002c1.84.163 3.737.46 5.62.89a3.75 3.75 0 0 1 .544-.176c2.126-.508 4.39-.85 6-.85a3.75 3.75 0 0 1 .75-.075v15a3.75 3.75 0 0 1-.75-.075c-1.61-.008-3.874-.35-6-.858a3.75 3.75 0 0 1-.544-.176c-1.88-.428-3.773-.725-5.61-.888a58.978 58.978 0 0 1-5.432-.002c-1.84.163-3.737.46-5.62.89a3.75 3.75 0 0 1-.544.176c-2.126.508-4.39.85-6 .85a3.75 3.75 0 0 1-.75.075V6a3.75 3.75 0 0 1 .75-.075c1.61-.008 3.874-.35 6-.858a3.75 3.75 0 0 1 .544-.176z" clip-rule="evenodd" />
                                        <!--<path d="M6.75 7.5a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5h-9a.75.75 0 0 1-.75-.75zM6.75 12a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5h-9A.75.75 0 0 1 6.75 12Zm0 4.5a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5h-9a.75.75 0 0 1-.75-.75z" /> -->
                                    </svg>
                                </x-slot>
                                {{ __('Semester Akademik') }}
                            </x-nav-link>
