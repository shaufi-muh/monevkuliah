                                ...
                                @forelse($usersProdi as $user)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('userprodi.edit', $user->id) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                            <form action="{{ route('userprodi.destroy', $user->id) }}" method="POST" class="inline ml-4">
                                                @csrf
                                                @method('DELETE')
