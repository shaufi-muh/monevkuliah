        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="font-semibold text-lg mb-4">Tambah Prodi Baru</h3>
                    <form action="{{ route('jurusan.dataprodi.store') }}" method="POST">
                        @csrf
                                ...
                                @forelse ($prodis as $prodi)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            <a href="{{ route('jurusan.dataprodi.edit', $prodi->id) }}" class="text-indigo-600 hover:text-indigo-900" title="Edit">
