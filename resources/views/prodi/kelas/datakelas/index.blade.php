   ...
   <x-slot name="header">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
                <h3 class="font-semibold text-lg mb-4">Tambah Data Kelas Baru</h3>
                <form action="{{ route('prodi.datakelas.store') }}" method="POST">
                    @csrf
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Urut Semester</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                <a href="{{ route('prodi.datakelas.edit', $kelas->id) }}" class="text-indigo-600 hover:text-indigo-900" title="Edit">
